...
class Tester:
    ...
    def searchByBookName(self, book_name: str):
        ...
        from lib_management_sys.searcher.search_by_book_name import SearchByBookName
    ...
    def searchByAuthorName(self, author_name: list):
        ...
        from lib_management_sys.searcher.search_by_author_name import SearchByAuthorName
    ...
    def searchByMemberName(self, member_name: str, token):
        ...
        from lib_management_sys.searcher.search_by_member_name import SearchByMemberName
    ...
    def searchByMemberId(self, member_id: list, token):
        ...
        from lib_management_sys.searcher.search_by_member_id import SearchByMemberId
    ...
    def addBook(self, book_name: str, publicationDate: str, author: str, token: str):
        ...
        """
        from lib_management_sys.book.book_details import BookDetails
        from lib_management_sys.book.book_copy import BookCopy
        from lib_management_sys.id_genrator.book_copy_id_genrator import BookCopyIdGenerator
    ...
    def deleteBook(self, book_copy_id: list, token: str):
        ...
        from lib_management_sys.searcher.search_book_by_id import SearchBookById
